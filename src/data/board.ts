...
export const secretariat: SecretariatMember[] = [
  ...
  { name: 'Amoolya Sreenath', position: 'Deputy Secretary General', email: 'dsg2@aimunsoc.org' },
  { name: 'Anushka Maneesh Rai', position: 'Director General', email: 'dg@aimunsoc.org' },
  { name: 'Vishakha Shivhare', position: 'USG – Head of Operations', email: 'operations1@aimunsoc.org' },
  { name: 'Anushka Vishwakarma', position: 'USG – Head of Operations', email: 'operations2@aimunsoc.org' },
  { name: 'Sujata Diwedi', position: 'Chief of Staff', email: 'cos@aimunsoc.org' },
  { name: 'Yadriksha Uprety', position: 'USG – Head of Finance', email: 'finance@aimunsoc.org' },
  { name: 'Amarthya Gari Thamappa', position: 'USG – Head of Sponsorship', email: 'sponsorship@aimunsoc.org' },
  { name: 'Yuvraj Singh', position: 'USG – Head of Logistics', email: 'logistics@aimunsoc.org' },
  { name: 'Angelica Hazel Daniel', position: 'USG – Head of Equity', email: 'equity@aimunsoc.org' },
  { name: 'Vaibhav Vaswani', position: 'USG – Head of Outreach & Marketing', email: 'marketing@aimunsoc.org' },
  { name: 'Adithya P Kumar', position: 'USG – Head of Content & Social Media', email: 'content@aimunsoc.org' },
  { name: 'Syed Armaan', position: 'USG – Head of Delegate Affairs', email: 'delegate@aimunsoc.org' },
];
