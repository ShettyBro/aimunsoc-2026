...
export const currentBoard: BoardMember[] = [
  ...
  { name: 'Anushka Maneesh Rai', position: 'General Secretary', image: '/TheBoard/placeholder.jpg' },
  { name: 'Anushka Vishwakarma', position: 'General Secretary', image: '/TheBoard/placeholder.jpg' },
  { name: 'Vishakha Shivhare', position: 'General Secretary', image: '/TheBoard/placeholder.jpg' },
  { name: 'Angelica Daniel', position: "Chargé d'Affaires", image: '/TheBoard/placeholder.jpg' },
  { name: 'Yadriksha Uprety', position: 'Treasurer', image: '/TheBoard/placeholder.jpg' },
  { name: 'Adithya P Kumar', position: 'Editor In-Chief', image: '/TheBoard/placeholder.jpg' },
  { name: 'Vaibhav Vaswani', position: 'Editor In-Chief', image: '/TheBoard/placeholder.jpg' },
  { name: 'Syed Armaan', position: 'Deputy Secretary', image: '/TheBoard/placeholder.jpg' },
