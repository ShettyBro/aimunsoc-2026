        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          >
            ...
            <div className="space-y-6">
              <a href="mailto:aitmunsoc@acharya.ac.in" className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <p className="text-white group-hover:text-gold transition-colors text-sm">aitmunsoc@acharya.ac.in</p>
                </div>
              </a>
              ...
              <a href="https://instagram.com/aimunsoc" target="_blank" rel="noopener noreferrer" className="flex items-start gap-4 group">
                <div className="bg-gold/10 w-10 h-10 rounded-lg flex items-center justify-center shrink-0 group-hover:bg-gold/20 transition-colors">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-muted text-xs uppercase tracking-widest mb-1">Phone</p>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <textarea className={`${inputCls} resize-none`} rows={5} placeholder="Your message..." value={form.message} onChange={(e) => set('message', e.target.value)} required />
              </div>
              <button
                type="submit"
